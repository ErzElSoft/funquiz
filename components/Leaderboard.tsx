...
const Leaderboard: React.FC<Props> = ({ players, onNext, final = false }) => {
  ...
  if (final) {
    ...
    return (
      <div className="flex flex-col items-center justify-center h-full w-full max-w-6xl mx-auto p-4 animate-in fade-in duration-700 relative z-10">
        <h1 className="text-5xl md:text-7xl font-black mb-8 drop-shadow-xl text-white tracking-tight uppercase">
          The Podium
        </h1>
          ...
          <div className="flex flex-col items-center w-1/3 md:w-1/4 animate-in slide-in-from-bottom duration-1000 delay-300 order-1">
            {second && (
             <>
              ...
              <div className="w-full h-48 md:h-64 bg-gradient-to-t from-gray-400 to-gray-300 rounded-t-xl shadow-2xl flex flex-col items-center justify-start pt-4 border-t-4 border-white/30 relative">
          ...
          <div className="flex flex-col items-center w-1/3 md:w-1/4 z-10 animate-in slide-in-from-bottom duration-1000 order-2">
            {first && (
             <>
              ...
              <div className="w-full h-64 md:h-80 bg-gradient-to-t from-yellow-500 to-yellow-400 rounded-t-xl shadow-[0_0_50px_rgba(250,204,21,0.4)] flex flex-col items-center justify-start pt-6 border-t-4 border-white/30 relative">
          ...
          <div className="flex flex-col items-center w-1/3 md:w-1/4 animate-in slide-in-from-bottom duration-1000 delay-500 order-3">
            {third && (
             <>
              ...
              <div className="w-full h-32 md:h-48 bg-gradient-to-t from-orange-600 to-orange-500 rounded-t-xl shadow-2xl flex flex-col items-center justify-start pt-4 border-t-4 border-white/30 relative">
                 <div className="bg-black/20 p-3 rounded-full mb-2">
                    <Medal className="w-8 h-8 md:w-12 md:h-12 text-white" />
                 </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full w-full max-w-4xl mx-auto p-4 relative z-10">
      ...
      <div className="w-full space-y-3 mb-12">
        {top5.map((player, idx) => (
          ...
          >
            <div className="w-16 font-black text-3xl text-gray-300">#{idx + 1}</div>
